            ...
            children: [
              width > 800
                  ? Container(
                      ...
                      height: 45,
                      child: TopMenu(scaffoldKey: scaffoldKey))
                  : Offstage(),
              width > 800
                  ? InkWell(
                      onTap: () {
              ...
              hideHome
                  ? Container(
                      ...
                      height: width > 800 ? 1500 : 1400,
                      child: TabBarView(controller: _tabController, children: [
                        Center(
                          child: NewArrivals(controller: _tabController),
                        ),
                        Center(
                          child: EveningDresses(controller: _tabController),
                        ),
                        Center(
