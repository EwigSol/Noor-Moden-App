...
class ProductCardState extends State<ProductCard> {
  ...
  Widget build(BuildContext context) {
    return singleItem(Images, "Noor Moden",
        "beautiful evening dress made of tulle", 1, widget.height);
  }

  Widget singleItem(List<String> bgImg, String headingText, String normalText,
      int colorIndex, double height) {
    return OnHover(
        val: -8.0,
        isProduct: true,
        isDrawer: false,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (_, index) =>
                              singleColor(allColors[index], index),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: selectedColor == index ? Colors.redAccent : Colors.black,
